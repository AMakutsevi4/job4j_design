...
CREATE TABLE flights3
(
    id              INT PRIMARY KEY,
    airline_id      INT REFERENCES airlines3 (id),
    airplane_id     INT REFERENCES airplanes3 (id),
    departure_date  DATE,
    flight_duration DECIMAL(5, 2)
);


INSERT INTO airlines3 (id, name, country, headquarters)
...
INSERT INTO airplanes3 (id, model, manufacturer, seating_capacity)
...
INSERT INTO flights3 (id, airline_id, airplane_id, departure_date, flight_duration)
...
SELECT manufacturer, AVG(flight_duration)
FROM flights3
JOIN airplanes3 ON flights3.airplane_id = airplanes3.id
GROUP BY manufacturer
HAVING AVG(flight_duration) > 4;
