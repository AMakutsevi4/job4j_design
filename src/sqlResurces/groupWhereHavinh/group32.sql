...
(
    id              INT PRIMARY KEY,
    airline_id      INT REFERENCES airlines4 (id),
    airplane_id     INT REFERENCES airplanes4 (id),
    departure_date  DATE,
    flight_duration DECIMAL(5, 2)
);

INSERT INTO airlines4 (id, name, country, headquarters)
...
INSERT INTO airplanes4 (id, model, manufacturer, seating_capacity)
...
INSERT INTO flights4 (id, airline_id, airplane_id, departure_date, flight_duration)
...
FROM
     flights4
JOIN
         airlines4 ON flights4.airline_id = airlines4.id
GROUP BY
         name
HAVING
       AVG(flight_duration) > 3;
