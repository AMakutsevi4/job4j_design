...
(
    ...
    category2_id INTEGER REFERENCES categories2 (id)
);
...
INSERT INTO products2 (name, quantity, price, category2_id)
...
WHERE id IN (SELECT category2_id  FROM products2 WHERE quantity > 30);
